...
export const metadata: Metadata = {
  title: "MVP - Prebuilt UI Component Library",
  description: "Build faster with MVP, a comprehensive prebuilt UI component library. Save hours of development time with production-ready React components.",
  keywords: "UI library, React components, component library, prebuilt components, design system",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "MVP - Prebuilt UI Component Library",
    description: "Build faster with production-ready React components. Customize easily and ship your project faster.",
    type: "website",
    siteName: "MVP"
  }
};
